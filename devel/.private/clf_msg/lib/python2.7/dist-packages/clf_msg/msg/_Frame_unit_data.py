...
"""autogenerated by genpy from clf_msg/Frame_unit_data.msg. Do not edit."""
import sys
...
class Frame_unit_data(genpy.Message):
  _md5sum = "94524db803ef68f0233d9f1413641076"
  _type = "clf_msg/Frame_unit_data"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# DataFrame
...
int32 data"""
  __slots__ = ['IMU','data']
  _slot_types = ['sensor_msgs/Imu','std_msgs/Int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Frame_unit_data, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_i().pack(self.data.data))
